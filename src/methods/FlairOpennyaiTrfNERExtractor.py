...
class FlairOpennyaiTrfNERExtractor(NERTransformerModel):
    def __init__(self, model_name: str = "flair_opennyai_trf", show_logs: bool = False):
...
if __name__ == "__main__":
    extractor = FlairOpennyaiTrfNERExtractor()
    start = time()
